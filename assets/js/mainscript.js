$(document).ready(function () {
    ...
    $('.hdrcarousel').owlCarousel({
        loop: true,
        nav: true,
        navText : ["<img src='/wp-content/themes/envx/assets/img/white-left-arrow.png' class='hdrcarousel-nav hdrcarousel-nav--left'>","<img src='/wp-content/themes/envx/assets/img/white-right-arrow.png' class='hdrcarousel-nav hdrcarousel-nav--right'>"],
        items: 1,
        autoplay:true,
